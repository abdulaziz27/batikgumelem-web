    ...
    <section class="bg-brown-100 py-12 px-4">
        <div class="text-center mb-3">
            ...
            <p class="text-gray-400 text-lg mt-2 max-w-2xl mx-auto">
                Jelajahi kisah-kisah menarik, tips kreatif, dan wawasan mendalam seputar dunia batik Gumelem dan warisan
                budaya Indonesia.
            </p>
        </div>
    </section>
        ...
        @if ($blogs->isNotEmpty())
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($blogs as $blog)
                    <div
                        class="bg-white rounded-lg shadow-md overflow-hidden flex flex-col w-full transition duration-300 ease-in-out transform hover:shadow-md hover:scale-105 hover:border-brown-400 hover:border-2">
                        ...
                        <div class="p-4 flex-grow flex flex-col">
                            ...
                            <p class="text-sm text-gray-600 mb-4 line-clamp-3">
                                {{ Str::limit(strip_tags($blog->content), 80) }}</p>
                        ...
                        <a href="{{ route('blogs.show', $blog->slug) }}" class="absolute inset-0 z-10"></a>
                    </div>
                @endforeach
            </div>
